...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('web_userprofile_follows', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm['web.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm['web.userprofile'], null=False))
        ))
        db.create_unique('web_userprofile_follows', ['from_userprofile_id', 'to_userprofile_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('web_userprofile_follows')
    ...
    models = {
        ...
        'web.company': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['web.Sector']"})
        },
        'web.post': {
            'Meta': {'object_name': 'Post'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['web.Category']"}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['web.Company']"}),
        ...
        'web.userprofile': {
            ...
            'follows': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'followed_by'", 'symmetrical': 'False', 'to': "orm['web.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
